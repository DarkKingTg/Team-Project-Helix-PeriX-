...
class WasteRiskEngine:
    ...
    def evaluate(self, payload: SupplyNodePayload) -> Dict[str, Any]:
        ...
        actual_temp = payload.iot_sensors.temperature_c if payload.storage_type == "cold_storage" else payload.weather.ambient_temp_c
        optimal_temp = 4.0 if payload.storage_type == "cold_storage" else 15.0
        delta_temp = max(0.0, actual_temp - optimal_temp)
        ...
        humidity = payload.iot_sensors.humidity_pct
        ...
        # 3. Ethylene Gas Auto-Catalysis (Ripping hormone)
